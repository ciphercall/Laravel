    ...
    <div class="widget-box" id="summary" style="width: 30%; margin-left: auto">
        ...
        <div class="form-group text-right" style="height: 100px">
            ...
            <div class="col-md-6 text-right">
                <a href="{{route('backend.chalan.renew', [$chalan->chalan_no, 'Cancelled'])}}" class="btn btn-sm btn-primary">
                    <i class="fa fa-refresh"></i> Renew Order
                </a>

                <a class="btn btn-sm btn-gray" href="{{route('backend.order.cancelled.index')}}">
