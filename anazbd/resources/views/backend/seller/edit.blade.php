...
@section('content')
    ...
    <div class="col-sm-9">
        ...
        <!-- Name -->
            ...
            {{--  Seller Charge in Taka  --}}
            <div class="form-group">
                <label class="col-sm-3" for="charge">Shopwise Charge ( TK )</label>
                <div class="col-sm-8">
                    <input type="text"
                           id="charge"
                           class="form-control input-sm"
                           name="charge"
                           required
                           value="{{ $seller->seller->charge }}"
                    >
                    <strong class=" red">{{ $errors->first('charge') }}</strong>
                </div>
            </div>

            {{--  Seller Product Commission Type  --}}
            <div class="form-group">
                <label class="col-sm-3" for="charge">Commission based On</label>
                <div class="col-sm-8">
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="is_commission_based_on_product" id="product" value="true" @if($seller->seller->is_commission_based_on_product) checked @endif>
                        <label class="form-check-label" for="inlineRadio1">Product</label>
                      </div>
                      <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="is_commission_based_on_product" id="amount" value="false" @if(!$seller->seller->is_commission_based_on_product) checked @endif>
                        <label class="form-check-label" for="inlineRadio2">Amount</label>
                      </div>
                </div>
            </div>
            <div id="commission-section" class="well {{ $seller->seller->is_commission_based_on_product ? 'hidden' : 'show' }}">
                {{--  Seller Commission Type  --}}
                <div class="form-group">
                    <label class="col-sm-3" for="charge">Commission Type</label>
                    <div class="col-sm-8">
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="commission_type" id="inlineRadio1" value="taka" @if($seller->seller->commission_type == 'taka') checked @endif>
                            <label class="form-check-label" for="inlineRadio1">Taka</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="commission_type" id="inlineRadio2" value="percent" @if($seller->seller->commission_type == "percent") checked @endif>
                            <label class="form-check-label" for="inlineRadio2">Percent</label>
                        </div>
                    </div>
                </div>
                {{--  Seller Commission Amount  --}}
                <div class="form-group">
                    <label class="col-sm-3" for="commission">Commission</label>
                    <div class="col-sm-8">
                        <input type="text"
                            id="commission"
                            class="form-control input-sm"
                            name="commission"
                            required
                            value="{{ $seller->seller->commission }}"
                        >
                ...
                <div class="form-group">
                    <label class="col-sm-3" for="delivery_charge">Delivery Charge</label>
                    <div class="col-sm-8">
                        <input type="text"
                            id="delivery_charge"
                            class="form-control input-sm"
                            ...
                            required
                            value="{{ $seller->seller->delivery_charge }}"
                        >
...
@push('js')
    <script type="text/javascript">
        ...
        $(document).on('change','#product',function(){
            $('#commission-section').addClass('hidden');
            $('#commission-section').removeClass('show');
        });
        $(document).on('change','#amount',function(){
            $('#commission-section').addClass('show');
            $('#commission-section').removeClass('hidden');
        });
