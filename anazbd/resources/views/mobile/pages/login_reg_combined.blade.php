                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <form href="#" id="register-form" action="{{ route('frontend.user.register') }}"
                                            ...
                                            <a id="mob_edit"
                                               style="position: absolute;left: 282px;top: 77px;z-index: 1;display: none;"><i
                                            ...
                                            <div class="che-box">
                                                <label class="checkbox-in">
                                                    ...
                                                    <a href="{{url('/quick-page/terms-and-conditions')}}"> Terms and Conditions </a> and <a href="{{url('/quick-page/privacy-policy')}}">Privacy
                                                        Policy </a>
                                                </label>
                                            </div>
                                            <div class="form-group">
