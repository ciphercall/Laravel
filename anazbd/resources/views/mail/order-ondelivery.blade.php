...
<div style="width: 800px;">
    <div>
        <div class="backgroundOrder" style="background-image: url('https://drive.google.com/uc?export=download&id=1BZnDXS1wmWaVPtnYhdEovktxSFlB_1P0');height: 211px;background-repeat: no-repeat;background-size: contain;">
    ...
    <div>
        ...
        <p style="padding:0;">
            Congratulations, Your order #{{ $order_no }} is in delivery. Thank you for your patience. Happy shopping.
        </p>
    </div>
    <div>
        <span class="col-12">
