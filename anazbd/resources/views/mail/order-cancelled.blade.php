...
<div style="width: 800px;">
    <div>
        <div class="backgroundOrder" style="background-image: url('https://drive.google.com/uc?export=download&id=180LcWTn-4TaMNIO75ourR_I_yMmzWauc');height: 211px;background-repeat: no-repeat;background-size: contain;">
    ...
    <div>
        ...
        <p style="padding:0;">
            Unfortunately, Your order #{{ $order_no }} has been cancelled. We are sorry for this. Please, try again or contact with our customer support team. If you have made any payment, your fund will be refund via the payment method you have used.
        </p>
    </div>
    <div>
        <span class="col-12">
