...
@php
    $cartItemGroup = collect($items)->groupBy(function ($cartItem){
...
<div style="width: 800px;">
    <div>
        <div class="backgroundOrder" style="background-image: url('https://drive.google.com/uc?export=download&id=1u-Mxd9j7GJMs6ofQop7ZapqdFZXXAXdQ');height: 211px;background-repeat: no-repeat;background-size: contain;">
    ...
    <div>
        ...
        <p style="padding:0;">
            Your order #{{ $order_no }} has been generated. Thank you for your patience and shopping with AnazBD.
        </p>
    </div>
    <div>
        <span class="col-12">
