...
<div style="width: 800px;">
    <div>
        <div class="backgroundOrder" style="background-image: url('https://drive.google.com/uc?export=download&id=1joZ1H9aOd_c0p3xggP3QCu02ZbcMKIQ1');height: 211px;background-repeat: no-repeat;background-size: contain;">
    ...
    <div>
        ...
        <p style="padding:0;">
            Your order #{{ $order_no }} has been delivered. Thank you for your patience and shopping with AnazBD.
        </p>
    </div>
    <div>
        <span class="col-12">
