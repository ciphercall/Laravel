...
<div style="width: 800px;">
    <div>
        <div class="backgroundOrder" style="background-image: url('https://drive.google.com/uc?export=download&id=1PLLKB-75fBRaGgRSRbIPfDgSCTNHlyFH');height: 211px;background-repeat: no-repeat;background-size: contain;">
    ...
    <div>
        ...
        <p style="padding:0;">
            Congrats, Your order #{{ $order_no }} has been accepted. Thank you for being with AnazBD.
        </p>
    </div>
    <div>
        <span class="col-12">
