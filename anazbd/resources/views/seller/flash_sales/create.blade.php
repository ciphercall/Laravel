...
<div class="card">
    <div class="row card-header-primary">
        <div class="col">
            <h5>New Flash Sale</h5>
        </div>
        <div class="col text-right">
            <a href="{{route('seller.campaign.flash_sale.index')}}" class="btn btn-success">Flash Sale List</a>
        </div>
    </div>
    <div class="card-body">
            <form role="form"
            ...
            <div class="row">
                ...
                <div class="col form-group">
                    <label class="col" for="date">
                        Flash Sale Till <sup class="text-danger">*</sup>
                    </label>
                    <div class="col">
                        <input type="text"
                               id="date"
                               ...
                               placeholder="2020-12-01"
                               style="width: 100%; text-align: center">
                        <strong class="red">{{ $errors->first('date_till') }}</strong>
                    </div>
                </div>
                <!-- Time -->
                <div class="col form-group">
                    <label class="col" for="time">
                ...
                <div class="form-group">
                     <table class="table table-bordered text-center" id="flash-table">
                        <thead>
                        <tr>
                            <th style="width: 10%; min-width:10px">SL</th>
                            <th style="width: 30%; min-width:30px">Item <sup class="text-danger">*</sup></th>
{{--                            <th style="width: 20%">Quantity <sup class="red">*</sup></th>--}}
                            <th style="width: 20% ; min-width:20px">Sale Percentage <sup class="text-danger">*</sup></th>
                            <th style="width: 15%; min-width:30px">Actions</th>
                        </tr>
                        </thead>
                        <tbody>
                        {{--templatte--}}
