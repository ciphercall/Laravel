...
@section('page_header')
    <i class="fa fa-plus"></i> Add Items in Collection
@stop
        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="card shadow-sm col-md-6">
                    <form action="{{route('seller.product.collection.store',$collection)}}" method="POST">
                    ...
                    <div class="card-body row">
                        ...
                        <div id="submit-btn" class="col-12 text-center" style="display: none">
...
@push('js')
    <script>
        $(document).on('click','#add_btn',function (){
            ...
            let row = "<tr id='row-"+id+"'><td>"+name+"</td><td><input type='hidden' name='item_id[]' value='"+id+"'><button type='button' data-id='"+id+"' id='delete_btn' class='btn btn-sm btn-danger'><i class='fa fa-trash'></i></button></td></tr>";
