...
html {
  ...
  body {  
    height: 100%;
    background: url("https://wallpapercave.com/wp/wp5757936.jpg") no-repeat left top;
...
<div class="text">
    <h1>404</h1>
      <h2>Uh, Ohh</h2>
    <h3>Can't See your malicious scripts ? Poor You. War is on. Try everything in your arsenal. We're ready for you.</h3>
  </div>
  <div class="torch"></div>
  <script
