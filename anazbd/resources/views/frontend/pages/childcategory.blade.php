                ...
                <div class="col-12">
                    <div class="breadcrumb_content">
                        <ul>
                            <li><a href="/">home</a></li>
                            <li>
                                <a href="{{route('frontend.category', $child_category->category->slug)}}">{{$child_category->category->name}}</a>
                            </li>
                            <li>
                                <a href="{{route('frontend.sub_category', $child_category->sub_category->slug)}}">{{$child_category->sub_category->name}}</a>
                            </li>
        ...
        <div class="row">
            <div class="col-md-12 ">
                <div class="shop_banner_thumb">
                    <img src="{{ asset($child_category->image??' ') }}" alt="">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-3 col-md-12 ">
                    @include('frontend.include.product-filter', ['route' => 'frontend.child_category', 'slug' => $child_category->slug,])
                </div>

                <div class="col-lg-9 col-md-12">
                    <!-- @include('frontend.include.product-topbar') -->

                    @include('frontend.include.product-clear-filter', ['route' => 'frontend.child_category', 'slug' => $child_category->slug])
