                    ...
                    <div class="md-stepper-horizontal orange">
                        @foreach ($orderstatus as $status)
                          @if($histories->contains('type',$status))
                            ...
                            <div class="md-step-title">{{ $status == 'Quality Checking' ? 'Quality Checked' : $status }}</div>
                ...
                <div class="row">
                    <div class="col-md-2">
                        <h4 style="float: right;"> {{ Carbon\Carbon::parse($history->time)->format('Y-m-d') }} <br>
                          @if($history->type == "Delivered") @else{{ Carbon\Carbon::parse($history->time)->format('H : i a') }}@endif
                        </h4>
                    </div>
                    ...
                    <div class="col-md-10">
                        <div class="timeline">
                            <div class="container-timeline right">
                                <div class="content">
                                    <h4>Order {{ $history->type == 'Quality Checking' ? 'Quality Checked' : $history->type }} </h4>
