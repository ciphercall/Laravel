                ...
                <div class="col-12">
                    <div class="breadcrumb_content">
                        <ul>
                            <li><a href="/">home</a></li>
                            <li>
                                <a href="{{route('frontend.category', $sub_category->category->slug)}}">{{$sub_category->category->name}}</a>
                            </li>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-3 col-md-12 ">
                    @include('frontend.include.product-filter', ['route' => 'frontend.sub_category', 'slug' => $sub_category->slug,])
                </div>

                <div class="col-lg-9 col-md-12">
                    <!-- @include('frontend.include.product-topbar') -->

                    @include('frontend.include.product-clear-filter', ['route' => 'frontend.sub_category', 'slug' => $sub_category->slug])
