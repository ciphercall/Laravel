        ...
        <div class="container">
            ...
            <div class="Checkout_section">
                <div class="checkout_form">
                            ...
                            <div class="checkout_form_left">
                                ...
                                <form action="{{route('frontend.checkout.post')}}" id="checkout-form" method="post">
                                    ...
                                    <div class="row">
                                        ...
                                        {{--                                                <input id="checkBox" checked name="is_same_as_Bill_add" type="checkbox" data-toggle="toggle" data-on="Yes" data-off="No">--}}
                                        {{--                                        </div>--}}
                                        ...
                                        {{--                                                </div>--}}
                                        {{--                                                @php--}}
                                        {{--                                                    $delivery_address = auth('web')->user()->delivery_address->first();--}}
                                        {{--                                                    if($delivery_address == null)--}}
                                        {{--                                                        $delivery_address = auth('web')->user()->billing_address->first();--}}
                                        {{--                                                @endphp--}}
                                        {{--                                                <div class="col-6 mb-20">--}}
                                        ...
                                        {{--                                                            style='width:100%;'>--}}
                                        {{--                                                        <option value="" disabled>Select Division</option>--}}
                                        {{--                                                        @foreach($shipping_divisions as $div)--}}
                                        {{--                                                            <option value="{{az_hash($div->id)}}"--}}
                                        {{--                                                            @if($delivery_address != null)--}}
                                        {{--                                                                {{$delivery_address->division_id == $div->id ? 'selected' : ''}}--}}
                                        {{--                                                                @endif>--}}
                                        {{--                                                                {{$div->name}}--}}
                                        {{--                                                            </option>--}}
                                        {{--                                                        @endforeach--}}
                                        ...
                                        {{--                                                            <option value="{{az_hash($city->id)}}"--}}
                                        {{--                                                            @if ($delivery_address != null)--}}
                                        {{--                                                                {{$delivery_address->city_id == $city->id ? 'selected' : ''}}--}}
                                        {{--                                                                @endif>--}}
                                        {{--                                                                {{$city->name}}--}}
                                        {{--                                                            </option>--}}
                                        {{--                                                        @endforeach--}}
                                        ...
                                        {{--                                                            <option value="{{az_hash($area->id)}}"--}}
                                        {{--                                                            @if ($delivery_address != null)--}}
                                        {{--                                                                {{$delivery_address->post_code_id == $area->id ? 'selected' : ''}}--}}
                                        {{--                                                                @endif>--}}
                                        {{--                                                                {{$area->name}}--}}
                                        {{--                                                            </option>--}}
                                        {{--                                                        @endforeach--}}
                                        ...
                                        {{--                                                           value="{{$delivery_address->address_line_1 ?? ''}}"--}}
                                        {{--                                                           placeholder="House number and street name">--}}
                                        {{--                                                    <span class="error"></span>--}}
                                        {{--                                                </div>--}}
                                        ...
                                        {{--                                                           value="{{$delivery_address->address_line_2 ?? ''}}"--}}
                                        {{--                                                           placeholder="Apartment, suite, unit etc. (optional)">--}}
                                        {{--                                                    <span class="error"></span>--}}
                                        {{--                                                </div>--}}
                                        {{--                                            </div>--}}
                    ...
                    @php
                        $mallItems = collect($cart->cart_items->where('active',true))->reject(function ($cartItem){
                            return $cartItem->seller->is_anazmall_seller != true;
                        });
                        $otherItems = collect($cart->cart_items->where('active',true))->reject(function ($cartItem){
                            return $cartItem->seller->is_premium != true;
                        });
                        $otherSellerItems = collect($cart->cart_items->where('active',true))->reject(function ($cartItem){
