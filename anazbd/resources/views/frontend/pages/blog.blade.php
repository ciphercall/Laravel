                            ...
                            <article class="single_blog">
                                ...
                                <figure>
                                    <div class="post_header">
                                        ...
                                        <div class="blog_meta">
                                            <span class="author">Posted by : <a href="#">{{ $blog->admin->name ??" " }}</a> / </span>
                                            {{-- <span class="meta_date">On : <a href="#">{{ ($blog->update->format('d/m/Y')) }}</a> /</span> --}}
                                            <span class="meta_date">On : <a href="#">
                                                {{ \Carbon\Carbon::parse($blog->create)->format('d-M-Y')}}</a> /</span>
                                            {{-- <span class="post_category">In : <a href="#">Company, Image, Travel</a></span> --}}
                                        </div>
                                    </div>
                                    <div class="blog_thumb">
                                        <img src="{{ asset($blog->large_image) }}" alt="{{ ($blog->large_image) }}">
                                    </div>
