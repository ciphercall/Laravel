...
@section('mobile')
    ...
    <!-- my account start  -->
    <div class="col account_page_bg" style="padding: 10px 0 28px;">
        <div class="container">
...
{{--                                                                <div class="col-12">Price:</div>--}}
                                            ...
                                            <div class="row">
                                                <div class="col text-center"><a href="{{ route('hybrid.order.view',$order->no) }}" style="color: forestgreen;">View</a></div>
                                                <div class="col text-center"><a href="{{route('hybrid.order.details',$order->no)}}" style="color: darkred">Details</a></div>
                                    ...
                                    <div class="login">
                                        <div class="login_form_container">
                                            <div class="account_login_form">
                                                <form action="{{ route('hybrid.user.profile.update',az_hash($user->id)) }}" method="POST">
                                                    @csrf
                                                        ...
                                                        <select class="" name="division" id="bill_division"
                                                            ...
                                                            @foreach($divisions as $div)
                                                                <option value="{{az_hash($div->id)}}"
                                                                    {{$user->division_id == $div->id ? 'selected' : ''}}>
                                                                    {{$div->name}}
                                                                </option>
                                                            @endforeach
                                                        </select>
                                                        ...
                                                        <select class="" name="area" id="bill_area"
                                                            ...
                                                            @foreach($areas as $area)
                                                                <option value="{{az_hash($area->id)}}"
                                                                    {{$user->post_code_id == $area->id ? 'selected' : ''}}>
                                                                    {{$area->name}}
                                                    ...
                                                    <div class="col text-center save_button primary_btn default_button">
                                ...
                                <div class="tab-pane fade" id="changePassword">
                                    ...
                                    <form id="password_change_form"
                                          action="{{ route('hybrid.user.password.update',az_hash($user->id)) }}" method="POST">
                                        @csrf
                                        <div class="row">
                                            <div class="col-md-2">
