...
@section('page_header')
    <i class="material-icons">receipt</i> Orders in Ready for Packing
@endsection
@section('title','Orders in Ready for Packing')
@section('content')
    <div class="row">
            ...
            <div class="card">
                <div class="card-header-primary">
                    <div class="row justify-content-between">
                        <p class="col">All Orders (Packing)</p>
...
{{--                                                <button onclick="return confirm('Are you sure?')" class="btn btn-sm btn-primary"><i class="material-icons">verified</i>Pass</button>--}}
{{--                                            </form>--}}
{{--                                            <button onclick="return confirm('Are you sure?')" type="button" class="btn btn-sm btn-danger"><i class="material-icons">warning</i>Fail</button>--}}
                                        </div>
                                    </td>
                                </tr>
                            @endforeach
