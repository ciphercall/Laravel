            ...
            <div class="card">
                <div class="card-header-primary">
                    <div class="row justify-content-between">
                        <p class="col">All Arrived Orders</p>
                                    ...
                                    <td>
                                        <div class="row justify-content-center">
                                            <form action="{{route('admin.orders.status',$order)}}" method="POST">
                                                ...
                                                <input type="hidden" name="status" value="Quality Checking">
                                                <button onclick="return confirm('Are you sure?')" class="btn btn-sm btn-primary"><i class="fa fa-user-check"></i> &nbsp; Send To QC</button>
                                            </form>
                                        </div>
                                    </td>
                                </tr>
