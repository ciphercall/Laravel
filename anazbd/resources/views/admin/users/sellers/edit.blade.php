                ...
                <!-- Name -->
                    ...
                    <div class="">
                        ...
                        <div class="col-sm-8">
                            ...
                            <div class="">
                                <input class="" type="radio" name="is_commission_based_on_product" id="amount" value="false" @if(!$seller->seller->is_commission_based_on_product) checked @endif>
                                <label class="form-check-label" for="inlineRadio2">Amount</label>
                            </div>
                        </div>
                    </div>
                    <div id="commission-section" class="bg-dark text-white rounded {{ $seller->seller->is_commission_based_on_product ? 'hidden' : 'show' }}">
                        {{--  Seller Commission Type  --}}
                        <div class="form-group">
                            <label class="col-sm-3" for="charge">Commission Type</label>
                            <div class="col-sm-8">
                                <div class="">
                                    <input class="" type="radio" name="commission_type" id="inlineRadio1" value="taka" @if($seller->seller->commission_type == 'taka') checked @endif>
                                    <label class="form-check-label" for="inlineRadio1">Taka</label>
                                </div>
                                <div class="">
                                    <input class="" type="radio" name="commission_type" id="inlineRadio2" value="percent" @if($seller->seller->commission_type == "percent") checked @endif>
